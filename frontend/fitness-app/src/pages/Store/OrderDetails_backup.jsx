...
const OrderDetails = () => {
    ...
    const shipping = 10.99; // Fixed shipping cost
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <p className="text-white/70 text-sm">
                                                    {order.addressId?.fullName || 'Customer Name'}<br />
                                                    {order.addressId?.addressLine1 || 'Address Line 1'}<br />
                                                    {order.addressId?.addressLine2 && `${order.addressId.addressLine2}`}<br />
                                                    {order.addressId?.city || 'City'}, {order.addressId?.state || 'State'} {order.addressId?.postalCode || 'ZIP'}<br />
                                            ...
                                            <div>
                                                ...
                                                <p className="text-white/70 text-sm">
                                                    Phone: {order.addressId?.phoneNumber || 'Not provided'}<br />
                                ...
                                <div className="bg-[#121225] border border-[#f67a45]/30 rounded-lg p-6 sticky top-6">
                                    ...
                                    <div className="mt-6 space-y-3">
                                        <div className="text-sm text-white/70">
                                            <strong className="text-white">Payment Method:</strong><br />
                                            {order.paymentMethod || 'Not specified'}
                                        </div>

                                        <div className="text-sm text-white/70">
                                            <strong className="text-white">Order ID:</strong><br />
                                            {order._id}
                                        </div>
                                    </div>
