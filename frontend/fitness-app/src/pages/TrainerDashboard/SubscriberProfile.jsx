        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-white font-medium">{subscriber.age}</span>
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              <span className="text-gray-400 min-w-[170px]">Fitness Goals:</span>
              <span className="text-white font-medium">
                {subscriber.fitnessGoals}
              </span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-gray-400 min-w-[170px]">Workout Per Week:</span>
              <span className="text-white font-medium">
                {subscriber.workoutPerWeek}
              </span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-gray-400 min-w-[170px]">
              ...
              <span className="text-white font-medium">
                {subscriber.preferredWorkoutDuration}
              </span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-gray-400 min-w-[170px]">Equipment Access:</span>
              <span className="text-white font-medium">
                {subscriber.equipmentAccess}
              </span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-gray-400 min-w-[170px]">Health Conditions:</span>
              <span className="text-white font-medium">
                {subscriber.healthConditions}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-80 flex flex-col items-center">
          ...
          <div className="w-full bg-[#18182f] rounded-xl p-4 mb-6 border border-[#f67a45]/20 shadow">
            ...
            <div className="text-white/90 font-medium">
              {subscriber.subscribePlan.name}
            </div>
            <div className="text-[#f67a45] font-bold">
              {subscriber.subscribePlan.price}
            </div>
            <div className="text-green-400 text-sm mt-1">
              {subscriber.subscribePlan.status}
            </div>
            <div className="text-gray-400 text-xs mt-1">
              Renews: {subscriber.subscribePlan.renews}
            </div>
          </div>
          {/* Action Buttons */}
