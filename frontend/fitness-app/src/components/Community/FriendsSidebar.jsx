...
/**
 * FriendsSidebar - Component for displaying friends list in sidebar
 * 
 * This component provides a fixed sidebar displaying the user's friends list
 * with filtering capabilities and quick access to friend management.
 * 
 * Features:
 * - Friends list display with profile pictures
 * - Search/filter functionality for friends
 * - Navigation to friend profiles (could be implemented)
 * - Friend status indicators (online/offline)
 * - "Add New Friends" shortcut button
 * 
 * The component fetches friends data from the API on mount.
 */
          ...
          {filteredFriends.map(friend => (
            <div key={friend._id} className="flex items-center">
              <div className="relative">
                ...
                {/* Online status indicator - currently commented out */}
